...
public class TablaDeColores {
  public static void main(String[] args) {
    ...
    //Ahora utilizamos las constantes definidas en la clase ConsoleColors del paquete colors
    System.out.println("┌────────┬───────────┬────────┬────────────────┐");
    System.out.println("│ Código │   Color   │ Código │     Color      │");
    System.out.println("├────────┼───────────┼────────┼────────────────┤");
    System.out.print("│   30   │" + ConsoleColors.BLACK + " negro " + ConsoleColors.RESET +"    │");
    System.out.println("   90   │" + ConsoleColors.BLACK_BRIGHT + " negro claro " + ConsoleColors.RESET + "   │");
    System.out.print("│   31   │" + ConsoleColors.RED + " rojo " + ConsoleColors.RESET + "     │");
    System.out.println("   91   │" + ConsoleColors.RED_BRIGHT + " rojo claro " + ConsoleColors.RESET + "    │");
    System.out.println("└────────┴───────────┴────────┴────────────────┘");
  }
}